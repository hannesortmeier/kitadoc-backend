...
-- Insert Children
INSERT INTO children (first_name, last_name, birthdate, admission_date, expected_school_enrollment) VALUES
    ('Anna', 'Müller', '2019-03-15', '2023-08-01', '2025-08-01'),
    ('Liam', 'Kowalski', '2018-11-20', '2023-08-01', NULL),
    ('Ben', 'Springer', '2019-07-08', NULL, '2025-08-01'),
    ('Noah', 'Brown', '2019-01-12', '2023-08-01', '2025-08-01'),
    ('Mia', 'Schneider', '2018-09-30', '2023-08-01', '2024-08-01'),
    ('Lucas', 'Ahmed', '2019-05-22', NULL, NULL),
    ('Charlotte', 'Becker', '2019-02-18', '2023-08-01', '2025-08-01'),
    ('Oliver', 'Popovic', '2018-12-05', '2023-09-01', '2024-08-01');
