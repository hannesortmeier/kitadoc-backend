...
run-dev:
	KINDERGARTEN_LOG_LEVEL=debug KINDERGARTEN_LOG_FORMAT=text KINDERGARTEN_SERVER_JWT_SECRET=dsjfhaksdfhasfh KINDERGARTEN_ADMIN_USERNAME=Leitung KINDERGARTEN_ADMIN_PASSWORD=admin KINDERGARTEN_NORMAL_USERNAME=Fachkraft KINDERGARTEN_NORMAL_PASSWORD=teacher bin/kitadoc-backend
